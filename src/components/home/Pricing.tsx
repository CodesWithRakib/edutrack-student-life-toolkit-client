    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold px-4 py-1 rounded-full flex items-center shadow-md">
              ...
              <div className="p-6 md:p-8">
                ...
                <button
                  className={cn(
                    "w-full py-3 rounded-lg font-medium mb-8 transition-all duration-300 transform hover:-translate-y-1",
                    plan.popular
        ...
        <div className="mt-16 md:mt-20 text-center max-w-2xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 md:p-8 border border-amber-100 dark:border-amber-900/30 shadow-sm transition-all duration-300 hover:shadow-md">
            ...
            <button className="text-amber-600 dark:text-amber-400 font-medium hover:underline transition-all duration-300 transform hover:scale-105">
              Contact Sales Team →
            </button>
          </div>
        </div>
